...
export function OrderDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: 123942193</DialogTitle>
        ...
        <Table>
          <TableBody>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">
                Lucas Henrique Pagliarin
              </TableCell>
            </TableRow>

            <TableRow>
              <TableCell className="text-muted-foreground">Telefone</TableCell>
              <TableCell className="flex justify-end">(54) 984031364</TableCell>
            </TableRow>

            <TableRow>
              <TableCell className="text-muted-foreground">E-mail</TableCell>
              <TableCell className="flex justify-end">
                lucas.pagliarin@gmail.com
              </TableCell>
            </TableRow>
        ...
        <Table>
          ...
          <TableFooter>
            <TableRow>
              ...
              <TableCell className="text-right">R$ 260,00</TableCell>
            </TableRow>
          </TableFooter>
        </Table>
      </div>
